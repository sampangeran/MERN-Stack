...
export default function HeroSection() {
	return (
		<div className="bg-darkBlue text-white py-32">
			<div className="flex w-[85%] mx-auto flex-col lg:flex-row items-center gap-6 justify-center">
				...
				<div className="text-center lg:text-left lg:w-[40%]">
					...
					<div className="flex gap-4 text-lg justify-center lg:justify-start my-6">
