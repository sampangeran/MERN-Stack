...
function CardClass() {
  return (
    <div className="bg-white rounded-xl font-cairo w-full lg:w-64 xl:w-72 shadow-xl flex-none overflow-hidden">
      ...
      <div className="p-4">
            ...
            <p className="text-sm">
              <span>
                <svg className="inline" width="18" height="18" viewBox="0 0 18 18" fill="none" xmlns="http://www.w3.org/2000/svg">
                  <g clip-path="url(#clip0_549_38741)">
                    <path
                      fill-rule="evenodd"
                      clip-rule="evenodd"
        ...
        <p className="mt-2 text-sm underline underline-offset-2 font-light text-center">Lihat Detail</p>
      </div>
    </div>
  );
}
